...
namespace ProductMonitor.Display_Code
{
    static class GuiController
    {
        ...
        public static void StartUp()
        {
            ...
            var myThread = new Thread(StartGui);
            myThread.Start();
        ...
        public static void Update(ICheckDisplay check)
        {
            try
            {
                if (_mainForm == null)
        ...
        static public ICheckDisplay[,] GetChecksInTable(string tab)
        {
        ...
        static public void TakeScreenshot(string tab, string saveLocation)
        {
